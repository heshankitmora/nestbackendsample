...
const answer_user_dto_1 = require("./dto/answer-user.dto");
let UserController = class UserController {
    ...
    async userAnswerQuestion(params, answerUserDto) {
...
__decorate([
    common_1.Put('/userquestionanswers/:userid'),
    common_1.HttpCode(common_1.HttpStatus.CREATED),
    __param(0, common_1.Param()), __param(1, common_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, answer_user_dto_1.AnswerUserDto]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "userAnswerQuestion", null);
